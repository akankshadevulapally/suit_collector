...
class game(gym.Env):
    ...
    def normalizeBoardV2(self):
        min_value = np.min(self.board)
        max_value = np.max(self.board)
        normalized_board = (self.board - min_value) / (max_value - min_value)
    ...
    PURPOSE:        The function normalizes the values on the game board to a range of [-1,1] to make it suitable 
                    for processing by the Agent Gold.
    ...
    def step(self, action):
        ...
        if(action >=0 and action <  42):
            ...
            if (
                ...
                return self.normalizeBoardV2(), -100, True, info
            ...
            if won:
                #print('Yay!! I won!')
                return self.normalizeBoardV2(), 110, True, info
            ...
            self.render()
            return self.normalizeBoardV2(), 0, True, info
        ...
        myaction = myaction = rd.randint(0,41)
        card1Pos = None
        card2Pos = None
        while True:
        ...
        # finally
        #self.render()
        return self.normalizeBoardV2(), reward, done, info 
    ...
    def render(self):
        ...
        print("normalize board = ", self.normalizeBoardV2())
    ...
    PURPOSE:        Creates a deep neural network model for the Q-learning algorithm used by Agent Gold to select actions.
